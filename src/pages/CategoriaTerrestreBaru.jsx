...
import p_islas from "../assets/imagenes/portadas/hero/barru.webp";
...
export function CategoriaTerrestreBaru() {
    ...
    fetch(`${API}/api/tours/`)
      ...
      .then(data => {
        ...
        const islasTours = toursRaw.filter(
          tour => tour.categoria && tour.categoria.toString().toUpperCase() === "TERRESTRES_BARU"
        );
        ...
        <main className="flex-grow">
          ...
          <div className="relative w-full h-[80vh] sm:h-[100vh] overflow-hidden">
            ...
            <div className="relative z-10 flex items-center justify-center h-full flex-col">
              <h1 className="text-[#fffffffe] text-5xl md:text-7xl font-black text-center">
                Tours Terrestre Baru
              </h1>
            </div>
          </div>
