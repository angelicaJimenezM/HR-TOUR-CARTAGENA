...
import p_islas from "../assets/imagenes/portadas/hero/maritimos.webp";
...
export function CategoriaPasadíasMarítimos() {
    ...
    fetch(`${API}/api/tours/`)
      ...
      .then(data => {
        ...
        const islasTours = toursRaw.filter(
          tour => tour.categoria && tour.categoria.toString().toUpperCase() === "PASADIAS_MARITIMOS"
        );
