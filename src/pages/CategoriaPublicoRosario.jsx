...
import p_islas from "../assets/imagenes/portadas/hero/isla_rosario.webp";
...
export function CategoriaPublicoRosario() {
    ...
    fetch(`${API}/api/tours/`)
      ...
      .then(data => {
        ...
        const islasTours = toursRaw.filter(
          tour => tour.categoria && tour.categoria.toString().toUpperCase() === "PUBLICO_ROSARIO"
        );
