...
import p_islas from "../assets/imagenes/portadas/hero/rosario.webp";
...
export function CategoriaClasicoRosario() {
    ...
    fetch(`${API}/api/tours/`)
      ...
      .then(data => {
        ...
        const islasTours = toursRaw.filter(
          tour => tour.categoria && tour.categoria.toString().toUpperCase() === "CLASICO_ROSARIO"
        );
                    ...
                    <div className="text-center my-6 bg-blue-50/50 p-4 rounded-xl max-w-md mx-auto border border-blue-100 shadow-sm">
                      ...
                      {tieneDescuentoNino ? (
                        <p className="text-sm font-semibold text-gray-700 mt-1">
                          {t("reservas.tarifaAdulto")} ({selectedTour.rango_edad_nino || "Niños"}): <span className="text-[#123499] font-bold">${precioNinoEspecial.toLocaleString("es-CO")} COP</span>
                        </p>
                      ) : (
