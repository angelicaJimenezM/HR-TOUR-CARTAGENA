...
export function Footer() {
  ...
  return (
    <div>
      <div className='flex flex-col items-center bg-[#ece2c6] py-8 border-t border-[#ece2c6]' id='redes'>
        <h1 className='text-2xl text-center font-comic font-bold text-[#be812d] mb-2 '>
          {t("footer.title")}
        </h1>
        <p className='text-gray-700 mb-6 ml-6 mr-6 text-center text-sm'>{t("footer.subtitle")}</p>
        ...
        <div className="mt-2 text-xs text-gray-600 space-x-4">
          <Link to="/PrivacyPolicy" className="hover:underline hover:text-[#be812d]">
            Política de Privacidad
          </Link>
          <span>|</span>
          <Link to="/TerminosYCondiciones" className="hover:underline hover:text-[#be812d]">
